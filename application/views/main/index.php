...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Caliteba</a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="light">
            <p class="text-faded">Lorem ipsum dolor. Sit amet interdum tristique platea mattis. Dictum in enim. Cras eget posuere. Quis ridiculus erat amet diam sed. Nullam praesent curabitur lectus curabitur ac id nonummy dui. Suspendisse sit mauris sodales nunc pellentesque. Pulvinar sapien praesentium curabitur sociosqu in. Sagittis tincidunt erat arcu viverra lectus felis leo.</p>
            <a class="btn btn-default btn-xl js-scroll-trigger" href="#services">Servicios</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="services">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 text-center">
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="#portfolio">Productos</a>
          </div>
        </div>
      </div>        
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <hr class="primary">
            <p>Quiere contratar nuestros servicios? Averiguar sobre nuestros productos? Envienos un email o llamenos!</p>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto text-center">
            ...
            <p>
              <a href="mailto:contacto@caliteba.com.ar">contacto@caliteba.com.ar</a>
            </p>
          </div>
        </div>
      </div>
